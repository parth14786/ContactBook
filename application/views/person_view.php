...
<title>Contact Book | Created By Parth Shah</title>
<link
	href="<?php echo base_url('assets/bootstrap/css/bootstrap.min.css')?>"
	rel="stylesheet">
<link href="<?php echo base_url('assets/bootstrap/css/style.css')?>"
	rel="stylesheet">
...
<style type="text/css">
@font-face {
	font-family: Pill_Gothic_600mg_Regular;
	src: url("assets/fonts/Pill_Gothic_600mg_Regular.eot")
		/* EOT file for IE */
}

@font-face {
	font-family: Pill_Gothic_600mg_Regular;
	src: url("assets/fonts/Pill_Gothic_600mg_Regular.ttf")
...
<body>
	<div class="container">
		<h1 style="font-size: 20pt">Contact Book | Made in CodeIgniter</h1>
		<h3>Person Data</h3>
		<br />
	...
	<script
		src="<?php echo base_url('assets/jquery/jquery-2.1.4.min.js')?>"></script>
	<script
	...
	<script
		src="<?php echo base_url('assets/datatables/js/dataTables.bootstrap.js')?>"></script>
	<script
...
function delete_person(id)
{
							...
							<div class="form-group">
								...
								<div class="col-md-9">
									<input name="dob" placeholder="yyyy-mm-dd"
										class="form-control datepicker" type="text"> <span
	...
	<!-- End Bootstrap modal -->
	<div>
		<p style="margin-left: 10%; margin-top: 5%;">&copy; 2017. ContactBook | Created By Parth Shah</p>
	</div>
</body>
</html>